        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-8 border border-slate-200 dark:border-slate-700">
            <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
              I am a senior technology leader with over 15 years of experience driving digital transformation 
              and operational excellence in the fintech and banking sectors. My expertise encompasses Technology Assets Management, Service Desk Management, Service Management, Change and Release Management, Network Operation Center (NOC), and Technology Operations Center (TOC). I specialize in building 
